...
const getDataForCity = (city) => {
  return new Promise((resolve, reject) => {
    ...
    let { robbery, burglary, violenceAndSexualOffences, total } = crimeData;
    robbery = parseFloat(robbery);
    burglary = parseFloat(burglary);
    violenceAndSexualOffences = parseFloat(violenceAndSexualOffences);
